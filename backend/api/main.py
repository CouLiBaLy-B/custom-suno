...
def _update_task(task_id: str, **kwargs):
    """Met à jour le statut d'une tâche en mémoire."""
...
class GenerationRequest(BaseModel):
    model_name: str = Field("musicgen", description="musicgen | stable_audio | bark")
...
async def generate_music(
    ...
    """Lance une génération musicale asynchrone."""
    ...
    return GenerationResponse(
        task_id=task_id,
        estimated_time_seconds=request.duration * 2,
...
async def get_audio(filename: str):
    """Retourne un fichier audio pour streaming/téléchargement."""
...
async def ws_progress(websocket: WebSocket, task_id: str):
    """WebSocket pour notifications de progression en temps réel."""
...
# ─────────────────────────────────────────────
#  Worker de génération asynchrone
# ─────────────────────────────────────────────
...
async def _run_generation(task_id: str, request: GenerationRequest):
    ...
    try:
        ...
        print(f"Échec de la génération {task_id}: {e}")
